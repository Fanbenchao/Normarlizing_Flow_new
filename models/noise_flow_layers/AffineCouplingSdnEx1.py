...
from models.noise_flow_layers.cond_utils import sdn_iso_model_params_3, sdn_model_params, sdn_model_params_ex1
...
class AffineCouplingSdnEx1(tfb.Bijector):
    ...
    def __init__(
            ...
            validate_args=False,
            name="real_nvp"):
        super(AffineCouplingSdnEx1,self).__init__(
