...
from models.noise_flow_layers.cond_utils import sdn_model_params_ex3, sdn_model_params_ex4
...
class AffineCouplingSdnEx4(tfb.Bijector):
    ...
    def __init__(
            ...
            name="real_nvp",
            gain_init=0.0):
        super(AffineCouplingSdnEx4,self).__init__(
    ...
    def _forward(self, x, yy, nlf0=None, nlf1=None, iso=None, cam=None):
        ...
        scale = sdn_model_params_ex4(yy, iso, self.gain_init)
        shift = 0.0
