...
from models.noise_flow_layers.cond_utils import sdn_model_params_ex3, sdn_model_params_ex4, sdn_model_params_ex5
...
class AffineCouplingSdnEx5(tfb.Bijector):
    ...
    def _forward(self, x, yy, nlf0=None, nlf1=None, iso=None, shutter=None):
        ...
        scale = sdn_model_params_ex5(yy, iso, self.gain_init, shutter, self.param_inits)
        shift = 0.0
