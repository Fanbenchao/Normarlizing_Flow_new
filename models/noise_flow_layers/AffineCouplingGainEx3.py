...
class AffineCouplingGainEx3(tfb.Bijector):
    ...
    def __init__(
            ...
            validate_args=False,
            name="real_nvp"):
        super(AffineCouplingGainEx3,self).__init__(
    ...
    def _forward(self, x, yy, nlf0=None, nlf1=None, iso=None, cam=None):
        ...
        scale = gain_model_params_ex3(iso)
        shift = 0.0
