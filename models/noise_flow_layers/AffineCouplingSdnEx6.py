...
class AffineCouplingSdnEx6(tfb.Bijector):
    ...
    def __init__(
            ...
            gain_init=0.0,
            param_inits=False):
        super(AffineCouplingSdnEx6,self).__init__(
    ...
    def _forward(self, x, yy, nlf0=None, nlf1=None, iso=None, cam=None):
        ...
        scale = sdn_model_params_ex6(yy, iso, self.gain_init, cam, self.param_inits)
        shift = 0.0
