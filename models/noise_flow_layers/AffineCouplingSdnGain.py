...
from models.noise_flow_layers.cond_utils import sdn_iso_model_params_3
...
class AffineCouplingSdnGain(tfb.Bijector):
    ...
    def __init__(
            ...
            validate_args=False,
            name="real_nvp"):
        super(AffineCouplingSdnGain,self).__init__(
    ...
    def _forward(self, x, yy, nlf0=None, nlf1=None, iso=None, cam=None):
        ...
        beta1, beta2 = sdn_iso_model_params_3(iso)
