...
from models.noise_flow_layers.cond_utils import sdn_iso_model_params_3, sdn_model_params
...
class AffineCouplingSdn(tfb.Bijector):
    ...
    def _forward_and_log_det_jacobian(self, x, yy, nlf0=None, nlf1=None, iso=None, shutter=None):
        ...
        if scale is None:
            ...
            log_abs_det_J = tf.reduce_sum(tf.compat.v1.log(scale), axis=[1, 2, 3])
    ...
    def _inverse_and_log_det_jacobian(self, y, yy, nlf0=None, nlf1=None, iso=None, shutter=None):
        ...
        if scale is None:
            ...
            log_abs_det_J_inv = - tf.reduce_sum(tf.compat.v1.log(scale), axis=[1, 2, 3])
        if self._last_layer:
